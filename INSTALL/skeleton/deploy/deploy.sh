...
then
  ...
  archiveDeployedManifest ${SITE_CLUSTER_LOCAL_YAML} ${DEPLOYED_SITE_CLUSTER_LOCAL_YAML}
  archiveDeployedManifest ${SITE_NAMESPACE_YAML} ${DEPLOYED_SITE_NAMESPACE_YAML}
else
